...
PentativeReconstructor.consumes.items(ItemStack.with(Items.silicon, 850, Items.phaseFabric, 600, F.fi("cutol"), 500, Items.surgeAlloy, 650)); 
PentativeReconstructor.category = Category.units;
PentativeReconstructor.requirements = ItemStack.with(Items.silicon, 5000, Items.phaseFabric, 2500, Items.lead, 8500, Items.thorium, 6000, Items.surgeAlloy, 4750, F.fi("cutol"), 2400);
...
HextativeReconstructor.consumes.items(ItemStack.with(Items.silicon, 1250, Items.surgeAlloy, 950, F.fi("palladium"), 650, F.fi("orbon"), 900));
HextativeReconstructor.category = Category.units;
HextativeReconstructor.requirements = ItemStack.with(Items.silicon, 5000, F.fi("orbon"), 2500, Items.lead, 8500, Items.thorium, 6000, F.fi("cutol"), 9000, F.fi("palladium"), 3000, Items.surgeAlloy, 5250);
...
ProjectionReconstructor.consumes.items(ItemStack.with(Items.silicon, 3500, F.fi("cutol"), 950, F.fi("meteorite"), 750, F.fi("contritum"), 500));
